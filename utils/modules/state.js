...
const SET_SYMBOLS_FROM_NORMALS_INTERATORS = [
  ...
  function(state, field) {
    ...
    const endValue = get(state, fields[1]);
    const startValue = get(state, fields[0]);
   ...
   */
  function(state, field) {
    const isLinked = field.indexOf('@') > 0;
